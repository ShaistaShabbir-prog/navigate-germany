...
const TRANSLATIONS = {
  ...
  ,
    ...
    about_kicker: "Built for real life",
    about_title: "A calmer way to find your next step",
    about_sub: "Navigate Germany brings scattered public information into clear, linked steps.",
    about_official: "Official-link focused",
    about_official_sub: "Public authorities and trusted services",
    about_explore: "Easy to explore",
    about_explore_sub: "By situation, guide, or Bundesland",
    about_mobile: "Mobile first",
    about_mobile_sub: "Designed to work like an app",
    about_free: "Free to use",
    about_free_sub: "No account or API key required",
    disclaimer_title: "Important:",
    disclaimer_text: "This platform provides general guidance and links to official German sources.",
    footer_desc: "A multilingual guide to help you live, work and settle in Germany.",
    footer_quick: "Quick Links",
    footer_popular: "Popular Guides",
    footer_jobs: "Residence & Jobs",
    footer_health: "Health Insurance",
    footer_home: "Finding a Home",
    footer_legal: "Legal Help",
    footer_language: "German Language",
    footer_emergency: "Emergency",
    footer_disclaimer_heading: "Disclaimer",
    hero_eyebrow: "",
    hero_start: "Start by State",
    hero_emergency: "Emergency Help",
    hero_trusted: "Trusted guidance",
    hero_trusted_sub: "Links to official German sources",
    journey_kicker: "Quick start",
    journey_new: "I am new in Germany",
    journey_new_sub: "First-week checklist",
    journey_visa: "I need visa / residence help",
    journey_visa_sub: "Permits and work routes",
    journey_housing: "I need housing help",
    journey_housing_sub: "Renting and tenant rights",
    journey_legal: "I need emergency / legal help",
    journey_legal_sub: "Rights, letters and deadlines",
    journey_language: "I want to learn German",
    journey_language_sub: "Daily phrases and practice",
    wizard_student: "Student Journey",
    wizard_student_sub: "Study, housing, insurance and residence.",
    wizard_worker: "Skilled Worker",
    wizard_worker_sub: "Visa, employment, Blue Card.",
    wizard_family: "Family",
    wizard_family_sub: "Reunification, childcare, school.",
    wizard_researcher: "Researcher / PhD",
    wizard_researcher_sub: "University, hosting agreement, residence.",
    wizard_entrepreneur: "Entrepreneur",
    wizard_entrepreneur_sub: "Business route, registration and taxes.",
    wizard_refugee: "Refugee / Asylum seeker",
    wizard_refugee_sub: "Safe, official routes to support.",
    translation_badge: "Full translation in progress",
    language_guide: "Open German language guide",
    saved: "Saved",
    more: "More"}
    about_kicker: 'Built for real life',
    about_title: 'A calmer way to find your next step',
    ...
    disclaimer_title: 'Important:',
    disclaimer_text: 'This platform provides general guidance and links to official German sources.',
    footer_desc: 'A multilingual guide with official links to help you live, work and settle in Germany.',
    footer_quick: 'Quick Links',
    footer_popular: 'Popular Guides',
    footer_jobs: 'Residence & Jobs',
    footer_health: 'Health Insurance',
    ...
    journey_language_sub: 'Daily phrases and practice',
    wizard_student: 'Student Journey',
    wizard_student_sub: 'Study, housing, insurance and residence steps.',
    wizard_worker: 'Skilled Worker',
    wizard_worker_sub: 'Visa, employment, Blue Card and settling in.',
    wizard_family: 'Family',
    wizard_family_sub: 'Reunification, childcare, school and benefits.',
    wizard_researcher: 'Researcher / PhD',
    wizard_researcher_sub: 'University, hosting agreement and residence.',
    wizard_entrepreneur: 'Entrepreneur',
    wizard_entrepreneur_sub: 'Business route, registration and taxes.',
    wizard_refugee: 'Refugee / Asylum seeker',
    wizard_refugee_sub: 'Safe, official routes to support and advice.',
    translation_badge: 'Full translation in progress',
    language_guide: 'Open German language guide',
    saved: 'Saved',
    more: 'More',,
  ...
  ,
    ...
    about_kicker: "Gebaut für den Alltag",
    about_title: "Ein ruhigerer Weg zu Ihrem nächsten Schritt",
    about_sub: "Navigate Germany fasst verstreute öffentliche Informationen in klaren Schritten zusammen.",
    about_official: "Fokus auf offizielle Links",
    about_official_sub: "Behörden und vertrauenswürdige Dienste",
    about_explore: "Einfach zu erkunden",
    about_explore_sub: "Nach Situation, Leitfaden oder Bundesland",
    about_mobile: "Mobile First",
    about_mobile_sub: "Entwickelt wie eine App",
    about_free: "Kostenlos",
    about_free_sub: "Kein Konto erforderlich",
    disclaimer_title: "Wichtig:",
    disclaimer_text: "Diese Plattform bietet allgemeine Orientierung und offizielle Links.",
    footer_desc: "Ein mehrsprachiger Leitfaden für das Leben in Deutschland.",
    footer_quick: "Schnelllinks",
    footer_popular: "Beliebte Leitfäden",
    footer_jobs: "Aufenthalt & Jobs",
    footer_health: "Krankenversicherung",
    footer_home: "Wohnung finden",
    footer_legal: "Rechtliche Hilfe",
    footer_language: "Deutsche Sprache",
    footer_emergency: "Notfall",
    footer_disclaimer_heading: "Haftungsausschluss",
    hero_eyebrow: "",
    hero_start: "Nach Bundesland starten",
    hero_emergency: "Notfallhilfe",
    hero_trusted: "Verlässliche Orientierung",
    hero_trusted_sub: "Links zu offiziellen deutschen Quellen",
    journey_kicker: "Schnellstart",
    journey_new: "Ich bin neu in Deutschland",
    journey_new_sub: "Checkliste erste Woche",
    journey_visa: "Ich brauche Visum-Hilfe",
    journey_visa_sub: "Genehmigungen und Arbeit",
    journey_housing: "Ich brauche Wohnhilfe",
    journey_housing_sub: "Mieten und Mieterrechte",
    journey_legal: "Ich brauche Rechtshilfe",
    journey_legal_sub: "Rechte und Fristen",
    journey_language: "Ich möchte Deutsch lernen",
    journey_language_sub: "Phrasen und Übungen",
    wizard_student: "Studentenweg",
    wizard_student_sub: "Studium, Wohnung, Versicherung.",
    wizard_worker: "Fachkraft",
    wizard_worker_sub: "Visum, Beschäftigung, Blaue Karte.",
    wizard_family: "Familie",
    wizard_family_sub: "Familiennachzug, Kinderbetreuung.",
    wizard_researcher: "Forscher / Promotion",
    wizard_researcher_sub: "Universität, Vereinbarung, Aufenthalt.",
    wizard_entrepreneur: "Unternehmer",
    wizard_entrepreneur_sub: "Geschäftsweg, Anmeldung, Steuern.",
    wizard_refugee: "Flüchtling / Asylsuchender",
    wizard_refugee_sub: "Sichere, offizielle Wege.",
    translation_badge: "Vollständige Übersetzung in Bearbeitung",
    language_guide: "Deutschen Sprachleitfaden öffnen",
    saved: "Gespeichert",
    more: "Mehr"}
    about_kicker: 'Gebaut für den Alltag',
    about_title: 'Ein ruhigerer Weg zu Ihrem nächsten Schritt',
    about_sub: 'Navigate Germany fasst verstreute öffentliche Informationen in klaren, verlinkten Schritten zusammen.',
    about_official: 'Fokus auf offizielle Links',
    about_official_sub: 'Behörden und vertrauenswürdige Dienste',
    about_explore: 'Einfach zu erkunden',
    about_explore_sub: 'Nach Situation, Leitfaden oder Bundesland',
    about_mobile: 'Mobile First',
    about_mobile_sub: 'Entwickelt, um wie eine App zu funktionieren',
    about_free: 'Kostenlos nutzbar',
    about_free_sub: 'Kein Konto oder API-Schlüssel erforderlich',
    disclaimer_title: 'Wichtig:',
    disclaimer_text: 'Diese Plattform bietet allgemeine Orientierung und Links zu offiziellen deutschen Quellen.',
    footer_desc: 'Ein mehrsprachiger Leitfaden mit offiziellen Links, der Ihnen hilft, in Deutschland zu leben, zu arbeiten und sich niederzulassen.',
    footer_quick: 'Schnelllinks',
    footer_popular: 'Beliebte Leitfäden',
    footer_jobs: 'Aufenthalt & Jobs',
    footer_health: 'Krankenversicherung',
    footer_home: 'Eine Wohnung finden',
    footer_legal: 'Rechtliche Hilfe',
    footer_language: 'Deutsche Sprache',
    footer_emergency: 'Notfall',
    footer_disclaimer_heading: 'Haftungsausschluss',
    ...
    journey_kicker: 'Schnellstart',
    journey_new: 'Ich bin neu in Deutschland',
    journey_new_sub: 'Checkliste für die erste Woche',
    journey_visa: 'Ich brauche Hilfe bei Visum / Aufenthalt',
    journey_visa_sub: 'Genehmigungen und Arbeitswege',
    journey_housing: 'Ich brauche Hilfe bei der Wohnungssuche',
    journey_housing_sub: 'Mieten und Mieterrechte',
    journey_legal: 'Ich brauche Notfall- / Rechtshilfe',
    journey_legal_sub: 'Rechte, Briefe und Fristen',
    journey_language: 'Ich möchte Deutsch lernen',
    journey_language_sub: 'Tägliche Phrasen und Übungen',
    wizard_student: 'Studentenweg',
    wizard_student_sub: 'Studium, Wohnung, Versicherung und Aufenthaltsschritte.',
    wizard_worker: 'Fachkraft',
    wizard_worker_sub: 'Visum, Beschäftigung, Blaue Karte und Niederlassung.',
    wizard_family: 'Familie',
    wizard_family_sub: 'Familienzusammenführung, Kinderbetreuung, Schule und Leistungen.',
    wizard_researcher: 'Forscher / Promotion',
    wizard_researcher_sub: 'Universität, Aufnahmevereinbarung und Aufenthalt.',
    wizard_entrepreneur: 'Unternehmer',
    wizard_entrepreneur_sub: 'Geschäftsweg, Anmeldung und Steuern.',
    wizard_refugee: 'Flüchtling / Asylsuchender',
    wizard_refugee_sub: 'Sichere, offizielle Wege zu Unterstützung und Beratung.',
    translation_badge: 'Vollständige Übersetzung in Bearbeitung',
    language_guide: 'Deutschen Sprachleitfaden öffnen',
    saved: 'Gespeichert',
    more: 'Mehr',,
  ...
  ,
    ...
    about_kicker: "مصمم للحياة الواقعية",
    about_title: "طريقة أهدأ للعثور على خطوتك التالية",
    about_sub: "ينظّم Navigate Germany المعلومات المتناثرة في خطوات واضحة.",
    about_official: "يركز على الروابط الرسمية",
    about_official_sub: "الجهات الحكومية والخدمات الموثوقة",
    about_explore: "سهل الاستكشاف",
    about_explore_sub: "حسب الوضع أو الدليل أو الولاية",
    about_mobile: "الجوال أولاً",
    about_mobile_sub: "مصمم ليعمل كتطبيق",
    about_free: "مجاني",
    about_free_sub: "لا يلزم حساب",
    disclaimer_title: "مهم:",
    disclaimer_text: "توفر هذه المنصة إرشادات عامة وروابط رسمية.",
    footer_desc: "دليل متعدد اللغات للحياة في ألمانيا.",
    footer_quick: "روابط سريعة",
    footer_popular: "أدلة مشهورة",
    footer_jobs: "الإقامة والوظائف",
    footer_health: "التأمين الصحي",
    footer_home: "إيجاد مسكن",
    footer_legal: "المساعدة القانونية",
    footer_language: "اللغة الألمانية",
    footer_emergency: "الطوارئ",
    footer_disclaimer_heading: "إخلاء المسؤولية",
    hero_eyebrow: "",
    hero_start: "ابدأ حسب الولاية",
    hero_emergency: "مساعدة طارئة",
    hero_trusted: "إرشاد موثوق",
    hero_trusted_sub: "روابط للمصادر الرسمية",
    journey_kicker: "بداية سريعة",
    journey_new: "أنا جديد في ألمانيا",
    journey_new_sub: "قائمة الأسبوع الأول",
    journey_visa: "أحتاج مساعدة بالتأشيرة",
    journey_visa_sub: "التصاريح والعمل",
    journey_housing: "أحتاج مساعدة في السكن",
    journey_housing_sub: "الإيجار والحقوق",
    journey_legal: "أحتاج مساعدة قانونية",
    journey_legal_sub: "الحقوق والمواعيد",
    journey_language: "أريد تعلم الألمانية",
    journey_language_sub: "عبارات يومية",
    wizard_student: "رحلة الطالب",
    wizard_student_sub: "الدراسة والسكن والتأمين.",
    wizard_worker: "عامل ماهر",
    wizard_worker_sub: "التأشيرة والعمل والبطاقة الزرقاء.",
    wizard_family: "العائلة",
    wizard_family_sub: "لم الشمل ورعاية الأطفال.",
    wizard_researcher: "باحث / دكتوراه",
    wizard_researcher_sub: "الجامعة واتفاقية الاستضافة.",
    wizard_entrepreneur: "رائد أعمال",
    wizard_entrepreneur_sub: "طريق العمل والتسجيل.",
    wizard_refugee: "لاجئ / طالب لجوء",
    wizard_refugee_sub: "مسارات رسمية آمنة.",
    translation_badge: "الترجمة الكاملة قيد التقدم",
    language_guide: "فتح دليل اللغة الألمانية",
    saved: "محفوظ",
    more: "المزيد"}
    about_kicker: 'مصمم للحياة الواقعية',
    about_title: 'طريقة أهدأ للعثور على خطوتك التالية',
    about_sub: 'ينظّم Navigate Germany المعلومات العامة المتناثرة في خطوات واضحة ومترابطة.',
    about_official: 'يركز على الروابط الرسمية',
    about_official_sub: 'الجهات الحكومية والخدمات الموثوقة',
    about_explore: 'سهل الاستكشاف',
    about_explore_sub: 'حسب الوضع أو الدليل أو الولاية',
    about_mobile: 'الجوال أولاً',
    about_mobile_sub: 'مصمم ليعمل كتطبيق',
    about_free: 'مجاني الاستخدام',
    about_free_sub: 'لا يلزم حساب أو مفتاح API',
    disclaimer_title: 'مهم:',
    disclaimer_text: 'توفر هذه المنصة إرشادات عامة وروابط للمصادر الرسمية الألمانية.',
    footer_desc: 'دليل متعدد اللغات بروابط رسمية لمساعدتك على العيش والعمل والاستقرار في ألمانيا.',
    footer_quick: 'روابط سريعة',
    footer_popular: 'أدلة مشهورة',
    footer_jobs: 'الإقامة والوظائف',
    footer_health: 'التأمين الصحي',
    ...
    hero_emergency: 'مساعدة طارئة',
    hero_trusted: 'إرشاد موثوق',
    hero_trusted_sub: 'روابط للمصادر الرسمية الألمانية',
    journey_kicker: 'بداية سريعة',
    journey_new: 'أنا جديد في ألمانيا',
    journey_new_sub: 'قائمة مراجعة الأسبوع الأول',
    journey_visa: 'أحتاج مساعدة في التأشيرة / الإقامة',
    journey_visa_sub: 'التصاريح وطرق العمل',
    journey_housing: 'أحتاج مساعدة في السكن',
    journey_housing_sub: 'الإيجار وحقوق المستأجر',
    journey_legal: 'أحتاج مساعدة طارئة / قانونية',
    journey_legal_sub: 'الحقوق والخطابات والمواعيد النهائية',
    journey_language: 'أريد تعلم الألمانية',
    journey_language_sub: 'عبارات يومية وممارسة',
    wizard_student: 'رحلة الطالب',
    wizard_student_sub: 'خطوات الدراسة والسكن والتأمين والإقامة.',
    wizard_worker: 'عامل ماهر',
    wizard_worker_sub: 'التأشيرة والتوظيف والبطاقة الزرقاء والاستقرار.',
    wizard_family: 'العائلة',
    wizard_family_sub: 'لم الشمل ورعاية الأطفال والمدرسة والمزايا.',
    wizard_researcher: 'باحث / دكتوراه',
    wizard_researcher_sub: 'الجامعة واتفاقية الاستضافة والإقامة.',
    wizard_entrepreneur: 'رائد أعمال',
    wizard_entrepreneur_sub: 'طريق العمل والتسجيل والضرائب.',
    wizard_refugee: 'لاجئ / طالب لجوء',
    wizard_refugee_sub: 'مسارات رسمية آمنة للدعم والمشورة.',
    translation_badge: 'الترجمة الكاملة قيد التقدم',
    language_guide: 'فتح دليل اللغة الألمانية',
    saved: 'محفوظ',
    more: 'المزيد',,
  ...
  ,
    ...
    about_kicker: "حقیقی زندگی کے لیے بنایا گیا",
    about_title: "اپنا اگلا قدم تلاش کرنے کا پرسکون طریقہ",
    about_sub: "نیویگیٹ جرمنی بکھری ہوئی معلومات کو واضح مربوط اقدامات میں لاتا ہے۔",
    about_official: "سرکاری لنکس پر توجہ",
    about_official_sub: "سرکاری ادارے اور قابل اعتماد خدمات",
    about_explore: "آسانی سے دریافت کریں",
    about_explore_sub: "صورتحال، رہنما یا وفاقی ریاست کے مطابق",
    about_mobile: "موبائل فرسٹ",
    about_mobile_sub: "ایپ کی طرح کام کرنے کے لیے",
    about_free: "مفت استعمال",
    about_free_sub: "کوئی اکاؤنٹ درکار نہیں",
    disclaimer_title: "اہم:",
    disclaimer_text: "یہ پلیٹ فارم عمومی رہنمائی اور سرکاری لنکس فراہم کرتا ہے۔",
    footer_desc: "جرمنی میں رہنے کے لیے ایک کثیر لسانی رہنما۔",
    footer_quick: "فوری لنکس",
    footer_popular: "مشہور رہنما",
    footer_jobs: "رہائش اور ملازمت",
    footer_health: "صحت انشورنس",
    footer_home: "گھر تلاش کرنا",
    footer_legal: "قانونی مدد",
    footer_language: "جرمن زبان",
    footer_emergency: "ہنگامی صورت",
    footer_disclaimer_heading: "دستبرداری",
    hero_eyebrow: "",
    hero_start: "ریاست کے ذریعے شروع کریں",
    hero_emergency: "ہنگامی مدد",
    hero_trusted: "قابل اعتماد رہنمائی",
    hero_trusted_sub: "سرکاری جرمن ذرائع کے لنکس",
    journey_kicker: "فوری آغاز",
    journey_new: "میں جرمنی میں نیا ہوں",
    journey_new_sub: "پہلے ہفتے کی فہرست",
    journey_visa: "مجھے ویزا مدد چاہیے",
    journey_visa_sub: "اجازت نامے اور کام",
    journey_housing: "مجھے رہائش مدد چاہیے",
    journey_housing_sub: "کرایہ اور حقوق",
    journey_legal: "مجھے قانونی مدد چاہیے",
    journey_legal_sub: "حقوق اور میعاد",
    journey_language: "میں جرمن سیکھنا چاہتا ہوں",
    journey_language_sub: "روزمرہ کے جملے",
    wizard_student: "طالب علم کا سفر",
    wizard_student_sub: "تعلیم، رہائش، بیمہ۔",
    wizard_worker: "ماہر کارکن",
    wizard_worker_sub: "ویزا، روزگار، بلیو کارڈ۔",
    wizard_family: "خاندان",
    wizard_family_sub: "اعادہ خاندان، بچوں کی دیکھ بھال۔",
    wizard_researcher: "محقق / پی ایچ ڈی",
    wizard_researcher_sub: "یونیورسٹی، معاہدہ، قیام۔",
    wizard_entrepreneur: "کاروباری",
    wizard_entrepreneur_sub: "کاروباری راستہ، رجسٹریشن۔",
    wizard_refugee: "مہاجر / پناہ گزین",
    wizard_refugee_sub: "محفوظ، سرکاری راستے۔",
    translation_badge: "مکمل ترجمہ جاری ہے",
    language_guide: "جرمن زبان رہنما کھولیں",
    saved: "محفوظ",
    more: "مزید"}
    about_kicker: 'حقیقی زندگی کے لیے بنایا گیا',
    about_title: 'اپنا اگلا قدم تلاش کرنے کا پرسکون طریقہ',
    about_sub: 'نیویگیٹ جرمنی بکھری ہوئی عوامی معلومات کو واضح مربوط اقدامات میں لاتا ہے۔',
    about_official: 'سرکاری لنکس پر توجہ',
    about_official_sub: 'سرکاری ادارے اور قابل اعتماد خدمات',
    about_explore: 'آسانی سے دریافت کریں',
    about_explore_sub: 'صورتحال، رہنما یا وفاقی ریاست کے مطابق',
    about_mobile: 'موبائل فرسٹ',
    about_mobile_sub: 'ایپ کی طرح کام کرنے کے لیے ڈیزائن کیا گیا',
    about_free: 'استعمال کے لیے مفت',
    about_free_sub: 'کوئی اکاؤنٹ یا API کلید درکار نہیں',
    disclaimer_title: 'اہم:',
    disclaimer_text: 'یہ پلیٹ فارم عمومی رہنمائی اور سرکاری جرمن ذرائع کے لنکس فراہم کرتا ہے۔',
    footer_desc: 'ایک کثیر لسانی رہنما جو آپ کو جرمنی میں رہنے، کام کرنے اور آباد ہونے میں مدد کرتا ہے۔',
    footer_quick: 'فوری لنکس',
    footer_popular: 'مشہور رہنما',
    footer_jobs: 'رہائش اور ملازمت',
    footer_health: 'صحت انشورنس',
    ...
    journey_kicker: 'فوری آغاز',
    journey_new: 'میں جرمنی میں نیا ہوں',
    journey_new_sub: 'پہلے ہفتے کی چیک لسٹ',
    journey_visa: 'مجھے ویزا / رہائش میں مدد چاہیے',
    journey_visa_sub: 'اجازت نامے اور کام کے راستے',
    journey_housing: 'مجھے رہائش میں مدد چاہیے',
    journey_housing_sub: 'کرایہ اور کرایہ دار کے حقوق',
    journey_legal: 'مجھے ہنگامی / قانونی مدد چاہیے',
    journey_legal_sub: 'حقوق، خطوط اور ڈیڈ لائنز',
    journey_language: 'میں جرمن سیکھنا چاہتا ہوں',
    journey_language_sub: 'روزمرہ کے جملے اور مشق',
    wizard_student: 'طالب علم کا سفر',
    wizard_student_sub: 'تعلیم، رہائش، بیمہ اور قیام کے اقدامات۔',
    wizard_worker: 'ماہر کارکن',
    wizard_worker_sub: 'ویزا، روزگار، بلیو کارڈ اور آباد کاری۔',
    wizard_family: 'خاندان',
    wizard_family_sub: 'اعادہ خاندان، بچوں کی دیکھ بھال، سکول اور فوائد۔',
    wizard_researcher: 'محقق / پی ایچ ڈی',
    wizard_researcher_sub: 'یونیورسٹی، میزبانی معاہدہ اور قیام۔',
    wizard_entrepreneur: 'کاروباری',
    wizard_entrepreneur_sub: 'کاروباری راستہ، رجسٹریشن اور ٹیکس۔',
    wizard_refugee: 'مہاجر / پناہ گزین',
    wizard_refugee_sub: 'مدد اور مشورے کے محفوظ، سرکاری راستے۔',
    translation_badge: 'مکمل ترجمہ جاری ہے',
    language_guide: 'جرمن زبان کی رہنما کھولیں',
    saved: 'محفوظ',
    more: 'مزید',,
  tr: {
    dir: "ltr",
  ...
  ,
    ...
    about_kicker: "Gerçek hayat için yapıldı",
    about_title: "Bir sonraki adımınızı bulmanın sakin yolu",
    about_sub: "Navigate Germany, dağınık bilgileri net adımlara dönüştürür.",
    about_official: "Resmi bağlantı odaklı",
    about_official_sub: "Kamu kurumları ve güvenilir hizmetler",
    about_explore: "Keşfetmesi kolay",
    about_explore_sub: "Duruma, rehbere veya eyalete göre",
    about_mobile: "Mobil öncelikli",
    about_mobile_sub: "Bir uygulama gibi çalışır",
    about_free: "Ücretsiz",
    about_free_sub: "Hesap gerekmez",
    disclaimer_title: "Önemli:",
    disclaimer_text: "Bu platform genel rehberlik ve resmi Alman bağlantıları sunar.",
    footer_desc: "Almanya'da yaşamak için çok dilli bir rehber.",
    footer_quick: "Hızlı Bağlantılar",
    footer_popular: "Popüler Rehberler",
    footer_jobs: "Oturma & İş",
    footer_health: "Sağlık Sigortası",
    footer_home: "Ev Bulmak",
    footer_legal: "Hukuki Yardım",
    footer_language: "Almanca",
    footer_emergency: "Acil Durum",
    footer_disclaimer_heading: "Sorumluluk Reddi",
    hero_eyebrow: "",
    hero_start: "Eyalete göre başla",
    hero_emergency: "Acil Yardım",
    hero_trusted: "Güvenilir rehberlik",
    hero_trusted_sub: "Resmi Alman kaynaklarına bağlantılar",
    journey_kicker: "Hızlı başlangıç",
    journey_new: "Almanya'da yeniyim",
    journey_new_sub: "İlk hafta listesi",
    journey_visa: "Vize yardımına ihtiyacım var",
    journey_visa_sub: "İzinler ve çalışma",
    journey_housing: "Konut yardımı gerekiyor",
    journey_housing_sub: "Kiralama ve haklar",
    journey_legal: "Hukuki yardım gerekiyor",
    journey_legal_sub: "Haklar ve son tarihler",
    journey_language: "Almanca öğrenmek istiyorum",
    journey_language_sub: "Günlük ifadeler",
    wizard_student: "Öğrenci Yolu",
    wizard_student_sub: "Eğitim, konut, sigorta.",
    wizard_worker: "Vasıflı İşçi",
    wizard_worker_sub: "Vize, istihdam, Mavi Kart.",
    wizard_family: "Aile",
    wizard_family_sub: "Aile birleşimi, çocuk bakımı.",
    wizard_researcher: "Araştırmacı / Doktora",
    wizard_researcher_sub: "Üniversite, misafirleme anlaşması.",
    wizard_entrepreneur: "Girişimci",
    wizard_entrepreneur_sub: "İş yolu, kayıt ve vergiler.",
    wizard_refugee: "Mülteci / Sığınmacı",
    wizard_refugee_sub: "Güvenli, resmi yollar.",
    translation_badge: "Tam çeviri devam ediyor",
    language_guide: "Almanca rehberini aç",
    saved: "Kaydedildi",
    more: "Daha fazla"}
    about_kicker: 'Gerçek hayat için yapıldı',
    about_title: 'Bir sonraki adımınızı bulmanın sakin yolu',
    about_sub: 'Navigate Germany, dağınık kamu bilgilerini net, bağlantılı adımlara dönüştürür.',
    about_official: 'Resmi bağlantı odaklı',
    about_official_sub: 'Kamu kurumları ve güvenilir hizmetler',
    about_explore: 'Keşfetmesi kolay',
    about_explore_sub: 'Duruma, rehbere veya eyalete göre',
    about_mobile: 'Mobil öncelikli',
    about_mobile_sub: 'Bir uygulama gibi çalışacak şekilde tasarlandı',
    about_free: 'Ücretsiz kullanım',
    about_free_sub: 'Hesap veya API anahtarı gerekmez',
    disclaimer_title: 'Önemli:',
    disclaimer_text: 'Bu platform genel rehberlik ve resmi Alman kaynaklarına bağlantılar sunar.',
    footer_desc: 'Almanya\'da yaşamanıza, çalışmanıza ve yerleşmenize yardımcı olmak için resmi bağlantıları içeren çok dilli bir rehber.',
    footer_quick: 'Hızlı Bağlantılar',
    footer_popular: 'Popüler Rehberler',
    footer_jobs: 'Oturma & İş',
    footer_health: 'Sağlık Sigortası',
    ...
    journey_kicker: 'Hızlı başlangıç',
    journey_new: 'Almanya\'da yeniyim',
    journey_new_sub: 'İlk hafta kontrol listesi',
    journey_visa: 'Vize / oturma izni yardımına ihtiyacım var',
    journey_visa_sub: 'İzinler ve çalışma yolları',
    journey_housing: 'Konut yardımına ihtiyacım var',
    journey_housing_sub: 'Kiralama ve kiracı hakları',
    journey_legal: 'Acil / hukuki yardıma ihtiyacım var',
    journey_legal_sub: 'Haklar, mektuplar ve son tarihler',
    journey_language: 'Almanca öğrenmek istiyorum',
    journey_language_sub: 'Günlük ifadeler ve pratik',
    wizard_student: 'Öğrenci Yolculuğu',
    wizard_student_sub: 'Eğitim, konut, sigorta ve ikamet adımları.',
    wizard_worker: 'Vasıflı İşçi',
    wizard_worker_sub: 'Vize, istihdam, Mavi Kart ve yerleşme.',
    wizard_family: 'Aile',
    wizard_family_sub: 'Aile birleşimi, çocuk bakımı, okul ve haklar.',
    wizard_researcher: 'Araştırmacı / Doktora',
    wizard_researcher_sub: 'Üniversite, misafirleme anlaşması ve ikamet.',
    wizard_entrepreneur: 'Girişimci',
    wizard_entrepreneur_sub: 'İş yolu, kayıt ve vergiler.',
    wizard_refugee: 'Mülteci / Sığınmacı',
    wizard_refugee_sub: 'Destek ve tavsiye için güvenli, resmi yollar.',
    translation_badge: 'Tam çeviri devam ediyor',
    language_guide: 'Almanca dil rehberini aç',
    saved: 'Kaydedildi',
    more: 'Daha fazla',,
  ru: {
    dir: "ltr",
  ...
  ,
    ...
    about_kicker: "Создано для реальной жизни",
    about_title: "Спокойный путь к следующему шагу",
    about_sub: "Navigate Germany собирает информацию в чёткие шаги.",
    about_official: "Официальные ссылки",
    about_official_sub: "Государственные органы",
    about_explore: "Легко исследовать",
    about_explore_sub: "По ситуации или земле",
    about_mobile: "Сначала мобильный",
    about_mobile_sub: "Как приложение",
    about_free: "Бесплатно",
    about_free_sub: "Без регистрации",
    disclaimer_title: "Важно:",
    disclaimer_text: "Платформа даёт советы и официальные ссылки.",
    footer_desc: "Многоязычный путеводитель по Германии.",
    footer_quick: "Быстрые ссылки",
    footer_popular: "Популярные руководства",
    footer_jobs: "Проживание и работа",
    footer_health: "Страховка",
    footer_home: "Поиск жилья",
    footer_legal: "Юридическая помощь",
    footer_language: "Немецкий язык",
    footer_emergency: "Экстренная помощь",
    footer_disclaimer_heading: "Отказ от ответственности",
    hero_eyebrow: "",
    hero_start: "Начать по земле",
    hero_emergency: "Экстренная помощь",
    hero_trusted: "Проверенные рекомендации",
    hero_trusted_sub: "Официальные источники",
    journey_kicker: "Быстрый старт",
    journey_new: "Я новичок",
    journey_new_sub: "Чеклист недели",
    journey_visa: "Нужна помощь с визой",
    journey_visa_sub: "Разрешения и работа",
    journey_housing: "Нужна помощь с жильём",
    journey_housing_sub: "Аренда и права",
    journey_legal: "Нужна юридическая помощь",
    journey_legal_sub: "Права и сроки",
    journey_language: "Хочу выучить немецкий",
    journey_language_sub: "Ежедневные фразы",
    wizard_student: "Путь студента",
    wizard_student_sub: "Учёба, жильё, страховка.",
    wizard_worker: "Специалист",
    wizard_worker_sub: "Виза, занятость, голубая карта.",
    wizard_family: "Семья",
    wizard_family_sub: "Воссоединение, уход за детьми.",
    wizard_researcher: "Исследователь / PhD",
    wizard_researcher_sub: "Университет, соглашение, проживание.",
    wizard_entrepreneur: "Предприниматель",
    wizard_entrepreneur_sub: "Бизнес, регистрация, налоги.",
    wizard_refugee: "Беженец",
    wizard_refugee_sub: "Безопасные официальные пути.",
    translation_badge: "Полный перевод в процессе",
    language_guide: "Открыть путеводитель",
    saved: "Сохранено",
    more: "Ещё"}
    about_kicker: 'Создано для реальной жизни',
    about_title: 'Спокойный путь к следующему шагу',
    about_sub: 'Navigate Germany собирает разрозненную публичную информацию в чёткие связанные шаги.',
    about_official: 'Фокус на официальных ссылках',
    about_official_sub: 'Государственные органы и проверенные сервисы',
    about_explore: 'Легко исследовать',
    about_explore_sub: 'По ситуации, руководству или земле',
    about_mobile: 'Сначала мобильный',
    about_mobile_sub: 'Разработан для работы как приложение',
    about_free: 'Бесплатное использование',
    about_free_sub: 'Не нужен аккаунт или API-ключ',
    disclaimer_title: 'Важно:',
    disclaimer_text: 'Эта платформа предоставляет общие рекомендации и ссылки на официальные немецкие источники.',
    footer_desc: 'Многоязычный путеводитель с официальными ссылками для жизни, работы и обустройства в Германии.',
    footer_quick: 'Быстрые ссылки',
    footer_popular: 'Популярные руководства',
    footer_jobs: 'Проживание и работа',
    footer_health: 'Медицинская страховка',
    footer_home: 'Поиск жилья',
    footer_legal: 'Юридическая помощь',
    footer_language: 'Немецкий язык',
    footer_emergency: 'Экстренная помощь',
    ...
    hero_emergency: 'Экстренная помощь',
    hero_trusted: 'Проверенные рекомендации',
    hero_trusted_sub: 'Ссылки на официальные немецкие источники',
    journey_kicker: 'Быстрый старт',
    journey_new: 'Я новичок в Германии',
    journey_new_sub: 'Чеклист первой недели',
    journey_visa: 'Мне нужна помощь с визой / проживанием',
    journey_visa_sub: 'Разрешения и пути к работе',
    journey_housing: 'Мне нужна помощь с жильём',
    journey_housing_sub: 'Аренда и права арендаторов',
    journey_legal: 'Мне нужна экстренная / юридическая помощь',
    journey_legal_sub: 'Права, письма и сроки',
    journey_language: 'Хочу выучить немецкий',
    journey_language_sub: 'Ежедневные фразы и практика',
    wizard_student: 'Путь студента',
    wizard_student_sub: 'Шаги по обучению, жилью, страховке и проживанию.',
    wizard_worker: 'Квалифицированный работник',
    wizard_worker_sub: 'Виза, трудоустройство, голубая карта и обустройство.',
    wizard_family: 'Семья',
    wizard_family_sub: 'Воссоединение, уход за детьми, школа и льготы.',
    wizard_researcher: 'Исследователь / PhD',
    wizard_researcher_sub: 'Университет, соглашение о принятии и проживание.',
    wizard_entrepreneur: 'Предприниматель',
    wizard_entrepreneur_sub: 'Бизнес-путь, регистрация и налоги.',
    wizard_refugee: 'Беженец / Ищущий убежище',
    wizard_refugee_sub: 'Безопасные официальные пути к поддержке и консультациям.',
    translation_badge: 'Полный перевод в процессе',
    language_guide: 'Открыть путеводитель по немецкому',
    saved: 'Сохранено',
    more: 'Ещё',,
  fr: {
    dir: "ltr",
  ...
  ,
    ...
    about_kicker: "Conçu pour la vraie vie",
    about_title: "Une façon plus sereine de trouver votre prochaine étape",
    about_sub: "Navigate Germany rassemble les informations en étapes claires.",
    about_official: "Axé sur les liens officiels",
    about_official_sub: "Autorités publiques et services de confiance",
    about_explore: "Facile à explorer",
    about_explore_sub: "Par situation, guide ou Bundesland",
    about_mobile: "Mobile d'abord",
    about_mobile_sub: "Comme une application",
    about_free: "Gratuit",
    about_free_sub: "Sans compte requis",
    disclaimer_title: "Important :",
    disclaimer_text: "Cette plateforme fournit des conseils et des liens officiels.",
    footer_desc: "Un guide multilingue pour l'Allemagne.",
    footer_quick: "Liens rapides",
    footer_popular: "Guides populaires",
    footer_jobs: "Résidence et emploi",
    footer_health: "Assurance maladie",
    footer_home: "Trouver un logement",
    footer_legal: "Aide juridique",
    footer_language: "Langue allemande",
    footer_emergency: "Urgence",
    footer_disclaimer_heading: "Avertissement",
    hero_eyebrow: "",
    hero_start: "Commencer par État",
    hero_emergency: "Aide d'urgence",
    hero_trusted: "Conseils de confiance",
    hero_trusted_sub: "Sources officielles allemandes",
    journey_kicker: "Démarrage rapide",
    journey_new: "Je suis nouveau en Allemagne",
    journey_new_sub: "Liste première semaine",
    journey_visa: "Aide pour le visa",
    journey_visa_sub: "Permis et travail",
    journey_housing: "Aide pour le logement",
    journey_housing_sub: "Location et droits",
    journey_legal: "Aide juridique",
    journey_legal_sub: "Droits et délais",
    journey_language: "Apprendre l'allemand",
    journey_language_sub: "Phrases quotidiennes",
    wizard_student: "Parcours étudiant",
    wizard_student_sub: "Études, logement, assurance.",
    wizard_worker: "Travailleur qualifié",
    wizard_worker_sub: "Visa, emploi, carte bleue.",
    wizard_family: "Famille",
    wizard_family_sub: "Regroupement, garde d'enfants.",
    wizard_researcher: "Chercheur / Doctorat",
    wizard_researcher_sub: "Université, accord d'accueil.",
    wizard_entrepreneur: "Entrepreneur",
    wizard_entrepreneur_sub: "Business, enregistrement, taxes.",
    wizard_refugee: "Réfugié",
    wizard_refugee_sub: "Voies officielles et sûres.",
    translation_badge: "Traduction complète en cours",
    language_guide: "Ouvrir le guide d'allemand",
    saved: "Enregistré",
    more: "Plus"}
    about_kicker: 'Conçu pour la vraie vie',
    about_title: 'Une façon plus sereine de trouver votre prochaine étape',
    about_sub: 'Navigate Germany rassemble les informations publiques éparses en étapes claires et liées.',
    about_official: 'Axé sur les liens officiels',
    about_official_sub: 'Autorités publiques et services de confiance',
    about_explore: 'Facile à explorer',
    about_explore_sub: 'Par situation, guide ou Bundesland',
    about_mobile: 'Mobile d\'abord',
    about_mobile_sub: 'Conçu pour fonctionner comme une application',
    about_free: 'Gratuit',
    about_free_sub: 'Aucun compte ou clé API requis',
    disclaimer_title: 'Important :',
    disclaimer_text: 'Cette plateforme fournit des conseils généraux et des liens vers des sources officielles allemandes.',
    footer_desc: 'Un guide multilingue avec des liens officiels pour vous aider à vivre, travailler et vous installer en Allemagne.',
    footer_quick: 'Liens rapides',
    footer_popular: 'Guides populaires',
    footer_jobs: 'Résidence et emploi',
    footer_health: 'Assurance maladie',
    ...
    hero_emergency: 'Aide d\'urgence',
    hero_trusted: 'Conseils de confiance',
    hero_trusted_sub: 'Liens vers les sources officielles allemandes',
    journey_kicker: 'Démarrage rapide',
    journey_new: 'Je suis nouveau en Allemagne',
    journey_new_sub: 'Liste de contrôle de la première semaine',
    journey_visa: 'J\'ai besoin d\'aide pour le visa / la résidence',
    journey_visa_sub: 'Permis et voies d\'emploi',
    journey_housing: 'J\'ai besoin d\'aide pour le logement',
    journey_housing_sub: 'Location et droits du locataire',
    journey_legal: 'J\'ai besoin d\'aide urgente / juridique',
    journey_legal_sub: 'Droits, courriers et délais',
    journey_language: 'Je veux apprendre l\'allemand',
    journey_language_sub: 'Phrases quotidiennes et pratique',
    wizard_student: 'Parcours étudiant',
    wizard_student_sub: 'Étapes d\'études, logement, assurance et résidence.',
    wizard_worker: 'Travailleur qualifié',
    wizard_worker_sub: 'Visa, emploi, carte bleue et installation.',
    wizard_family: 'Famille',
    wizard_family_sub: 'Regroupement, garde d\'enfants, école et aides.',
    wizard_researcher: 'Chercheur / Doctorat',
    wizard_researcher_sub: 'Université, accord d\'accueil et résidence.',
    wizard_entrepreneur: 'Entrepreneur',
    wizard_entrepreneur_sub: 'Voie entrepreneuriale, enregistrement et taxes.',
    wizard_refugee: 'Réfugié / Demandeur d\'asile',
    wizard_refugee_sub: 'Voies officielles et sûres vers le soutien et les conseils.',
    translation_badge: 'Traduction complète en cours',
    language_guide: 'Ouvrir le guide de langue allemande',
    saved: 'Enregistré',
    more: 'Plus',,
  fa: {
    dir: "rtl",
  ...
  ,
    ...
    about_kicker: "ساخته شده برای زندگی واقعی",
    about_title: "راهی آرام‌تر برای یافتن گام بعدی",
    about_sub: "Navigate Germany اطلاعات پراکنده را در مراحل واضح ارائه می‌دهد.",
    about_official: "تمرکز بر لینک‌های رسمی",
    about_official_sub: "مراجع دولتی و خدمات معتبر",
    about_explore: "آسان برای کاوش",
    about_explore_sub: "بر اساس موقعیت، راهنما یا ایالت",
    about_mobile: "موبایل اول",
    about_mobile_sub: "طراحی شده مثل یک اپلیکیشن",
    about_free: "رایگان",
    about_free_sub: "نیازی به حساب نیست",
    disclaimer_title: "مهم:",
    disclaimer_text: "این پلتفرم راهنمایی عمومی و لینک‌های رسمی ارائه می‌دهد.",
    footer_desc: "راهنمایی چندزبانه برای زندگی در آلمان.",
    footer_quick: "لینک‌های سریع",
    footer_popular: "راهنماهای محبوب",
    footer_jobs: "اقامت و شغل",
    footer_health: "بیمه درمانی",
    footer_home: "پیدا کردن خانه",
    footer_legal: "کمک قانونی",
    footer_language: "زبان آلمانی",
    footer_emergency: "اورژانس",
    footer_disclaimer_heading: "سلب مسئولیت",
    hero_eyebrow: "",
    hero_start: "شروع بر اساس ایالت",
    hero_emergency: "کمک اضطراری",
    hero_trusted: "راهنمایی معتبر",
    hero_trusted_sub: "لینک‌های منابع رسمی آلمانی",
    journey_kicker: "شروع سریع",
    journey_new: "من تازه وارد آلمان هستم",
    journey_new_sub: "چک‌لیست هفته اول",
    journey_visa: "به کمک ویزا نیاز دارم",
    journey_visa_sub: "مجوزها و کار",
    journey_housing: "به کمک مسکن نیاز دارم",
    journey_housing_sub: "اجاره و حقوق",
    journey_legal: "به کمک قانونی نیاز دارم",
    journey_legal_sub: "حقوق و مهلت‌ها",
    journey_language: "می‌خواهم آلمانی یاد بگیرم",
    journey_language_sub: "جملات روزانه",
    wizard_student: "مسیر دانشجو",
    wizard_student_sub: "تحصیل، مسکن، بیمه.",
    wizard_worker: "کارگر ماهر",
    wizard_worker_sub: "ویزا، اشتغال، کارت آبی.",
    wizard_family: "خانواده",
    wizard_family_sub: "اتحاد خانواده، مراقبت از کودک.",
    wizard_researcher: "محقق / دکترا",
    wizard_researcher_sub: "دانشگاه، توافقنامه میزبانی.",
    wizard_entrepreneur: "کارآفرین",
    wizard_entrepreneur_sub: "مسیر کسب‌وکار، ثبت.",
    wizard_refugee: "پناهنده / متقاضی",
    wizard_refugee_sub: "مسیرهای امن و رسمی.",
    translation_badge: "ترجمه کامل در حال انجام است",
    language_guide: "باز کردن راهنمای زبان",
    saved: "ذخیره شد",
    more: "بیشتر"}
    about_kicker: 'ساخته شده برای زندگی واقعی',
    about_title: 'راهی آرام‌تر برای یافتن گام بعدی',
    about_sub: 'Navigate Germany اطلاعات عمومی پراکنده را در قالب مراحل واضح و مرتبط ارائه می‌دهد.',
    about_official: 'تمرکز بر لینک‌های رسمی',
    about_official_sub: 'مراجع دولتی و خدمات معتبر',
    about_explore: 'آسان برای کاوش',
    about_explore_sub: 'بر اساس موقعیت، راهنما یا ایالت',
    about_mobile: 'موبایل اول',
    about_mobile_sub: 'طراحی شده برای کار مثل یک اپلیکیشن',
    about_free: 'رایگان برای استفاده',
    about_free_sub: 'نیازی به حساب کاربری یا کلید API نیست',
    disclaimer_title: 'مهم:',
    disclaimer_text: 'این پلتفرم راهنمایی عمومی و لینک‌های منابع رسمی آلمانی ارائه می‌دهد.',
    footer_desc: 'راهنمایی چندزبانه با لینک‌های رسمی برای کمک به زندگی، کار و اقامت در آلمان.',
    footer_quick: 'لینک‌های سریع',
    footer_popular: 'راهنماهای محبوب',
    footer_jobs: 'اقامت و شغل',
    footer_health: 'بیمه درمانی',
    ...
    journey_new: 'من تازه وارد آلمان هستم',
    journey_new_sub: 'چک‌لیست هفته اول',
    journey_visa: 'به کمک در ویزا / اقامت نیاز دارم',
    journey_visa_sub: 'مجوزها و مسیرهای کاری',
    journey_housing: 'به کمک مسکن نیاز دارم',
    journey_housing_sub: 'اجاره و حقوق مستأجر',
    journey_legal: 'به کمک اضطراری/قانونی نیاز دارم',
    journey_legal_sub: 'حقوق، نامه‌ها و مهلت‌ها',
    journey_language: 'می‌خواهم آلمانی یاد بگیرم',
    journey_language_sub: 'جملات روزانه و تمرین',
    wizard_student: 'مسیر دانشجو',
    wizard_student_sub: 'مراحل تحصیل، مسکن، بیمه و اقامت.',
    wizard_worker: 'کارگر ماهر',
    wizard_worker_sub: 'ویزا، اشتغال، کارت آبی و استقرار.',
    wizard_family: 'خانواده',
    wizard_family_sub: 'اتحاد مجدد خانواده، مراقبت از کودک، مدرسه و مزایا.',
    wizard_researcher: 'محقق / دکترا',
    wizard_researcher_sub: 'دانشگاه، موافقتنامه میزبانی و اقامت.',
    wizard_entrepreneur: 'کارآفرین',
    wizard_entrepreneur_sub: 'مسیر کسب‌وکار، ثبت و مالیات.',
    wizard_refugee: 'پناهنده / متقاضی پناهندگی',
    wizard_refugee_sub: 'مسیرهای امن و رسمی برای حمایت و مشاوره.',
    translation_badge: 'ترجمه کامل در حال انجام است',
    language_guide: 'باز کردن راهنمای زبان آلمانی',
    saved: 'ذخیره شد',
    more: 'بیشتر',,
  it: {
    nav_home: "Home",
  ...
  ,
    ...
    about_kicker: "Створено для реального життя",
    about_title: "Спокійний спосіб знайти наступний крок",
    about_sub: "Navigate Germany збирає інформацію у чіткі кроки.",
    about_official: "Офіційні посилання",
    about_official_sub: "Державні органи та перевірені сервіси",
    about_explore: "Легко досліджувати",
    about_explore_sub: "За ситуацією або землею",
    about_mobile: "Спочатку мобільний",
    about_mobile_sub: "Як додаток",
    about_free: "Безкоштовно",
    about_free_sub: "Без реєстрації",
    disclaimer_title: "Важливо:",
    disclaimer_text: "Платформа надає поради та офіційні посилання.",
    footer_desc: "Багатомовний путівник для Німеччини.",
    footer_quick: "Швидкі посилання",
    footer_popular: "Популярні путівники",
    footer_jobs: "Проживання та робота",
    footer_health: "Страхування",
    footer_home: "Пошук житла",
    footer_legal: "Юридична допомога",
    footer_language: "Німецька мова",
    footer_emergency: "Надзвичайна ситуація",
    footer_disclaimer_heading: "Відмова",
    hero_eyebrow: "",
    hero_start: "Почати за землею",
    hero_emergency: "Екстрена допомога",
    hero_trusted: "Перевірені поради",
    hero_trusted_sub: "Офіційні джерела",
    journey_kicker: "Швидкий старт",
    journey_new: "Я новачок",
    journey_new_sub: "Чекліст тижня",
    journey_visa: "Потрібна допомога з візою",
    journey_visa_sub: "Дозволи та робота",
    journey_housing: "Потрібна допомога з житлом",
    journey_housing_sub: "Оренда та права",
    journey_legal: "Потрібна юридична допомога",
    journey_legal_sub: "Права і дедлайни",
    journey_language: "Хочу вивчити німецьку",
    journey_language_sub: "Щоденні фрази",
    wizard_student: "Шлях студента",
    wizard_student_sub: "Навчання, житло, страхування.",
    wizard_worker: "Фахівець",
    wizard_worker_sub: "Віза, зайнятість, синя картка.",
    wizard_family: "Сім'я",
    wizard_family_sub: "Возз'єднання, дитячий догляд.",
    wizard_researcher: "Дослідник / PhD",
    wizard_researcher_sub: "Університет, угода, проживання.",
    wizard_entrepreneur: "Підприємець",
    wizard_entrepreneur_sub: "Бізнес, реєстрація, податки.",
    wizard_refugee: "Біженець",
    wizard_refugee_sub: "Безпечні офіційні шляхи.",
    translation_badge: "Повний переклад у процесі",
    language_guide: "Відкрити путівник",
    saved: "Збережено",
    more: "Більше"},
};
...
const UI_TEXT = 
    about_kicker: 'Створено для реального життя',
    about_title: 'Спокійний спосіб знайти наступний крок',
    about_sub: 'Navigate Germany збирає розрізнену публічну інформацію у чіткі, пов\'язані кроки.',
    about_official: 'Орієнтований на офіційні посилання',
    about_official_sub: 'Державні органи та перевірені сервіси',
    about_explore: 'Легко досліджувати',
    about_explore_sub: 'За ситуацією, путівником або землею',
    about_mobile: 'Спочатку мобільний',
    about_mobile_sub: 'Розроблено для роботи як додаток',
    about_free: 'Безкоштовне використання',
    about_free_sub: 'Не потрібен акаунт або API-ключ',
    disclaimer_title: 'Важливо:',
    disclaimer_text: 'Ця платформа надає загальні поради та посилання на офіційні німецькі джерела.',
    footer_desc: 'Багатомовний путівник з офіційними посиланнями для проживання, роботи та облаштування в Німеччині.',
    footer_quick: 'Швидкі посилання',
    footer_popular: 'Популярні путівники',
    footer_jobs: 'Проживання та робота',
    footer_health: 'Медичне страхування',
    footer_home: 'Пошук житла',
    footer_legal: 'Юридична допомога',
    footer_language: 'Німецька мова',
    footer_emergency: 'Надзвичайна ситуація',
    footer_disclaimer_heading: 'Відмова від відповідальності',
    hero_eyebrow: '',
    hero_start: 'Почати за землею',
    hero_emergency: 'Екстрена допомога',
    hero_trusted: 'Перевірені поради',
    hero_trusted_sub: 'Посилання на офіційні німецькі джерела',
    journey_kicker: 'Швидкий старт',
    journey_new: 'Я новачок у Німеччині',
    journey_new_sub: 'Чекліст першого тижня',
    journey_visa: 'Мені потрібна допомога з візою / проживанням',
    journey_visa_sub: 'Дозволи та шляхи до роботи',
    journey_housing: 'Мені потрібна допомога з житлом',
    journey_housing_sub: 'Оренда та права орендарів',
    journey_legal: 'Мені потрібна екстрена / юридична допомога',
    journey_legal_sub: 'Права, листи та дедлайни',
    journey_language: 'Хочу вивчити німецьку',
    journey_language_sub: 'Щоденні фрази та практика',
    wizard_student: 'Шлях студента',
    wizard_student_sub: 'Кроки навчання, житла, страхування та проживання.',
    wizard_worker: 'Кваліфікований працівник',
    wizard_worker_sub: 'Віза, зайнятість, блакитна карта та облаштування.',
    wizard_family: 'Сім\'я',
    wizard_family_sub: 'Возз\'єднання, дитячий догляд, школа та пільги.',
    wizard_researcher: 'Дослідник / PhD',
    wizard_researcher_sub: 'Університет, угода про прийом та проживання.',
    wizard_entrepreneur: 'Підприємець',
    wizard_entrepreneur_sub: 'Шлях бізнесу, реєстрація та податки.',
    wizard_refugee: 'Біженець / Шукач притулку',
    wizard_refugee_sub: 'Безпечні офіційні шляхи до підтримки та консультації.',
    translation_badge: 'Повний переклад у процесі',
    language_guide: 'Відкрити путівник з німецької мови',
    saved: 'Збережено',
    more: 'Більше',{
...
const PAGE_TEXT = {
  ...
  hi: {
    ...
    about_kicker: "वास्तविक जीवन के लिए बनाया गया",
    about_title: "अगला कदम खोजने का शांत तरीका",
    about_sub: "Navigate Germany बिखरी जानकारी को स्पष्ट चरणों में लाता है।",
    about_official: "आधिकारिक-लिंक केंद्रित",
    about_official_sub: "सरकारी प्राधिकरण और सेवाएँ",
    about_explore: "तलाश करना आसान",
    about_explore_sub: "स्थिति, गाइड या बुंडेसलैंड",
    about_mobile: "मोबाइल फर्स्ट",
    about_mobile_sub: "ऐप की तरह काम करता है",
    about_free: "मुफ़्त",
    about_free_sub: "कोई खाता आवश्यक नहीं",
    disclaimer_title: "महत्वपूर्ण:",
    disclaimer_text: "यह प्लेटफ़ॉर्म मार्गदर्शन और आधिकारिक लिंक प्रदान करता है।",
    footer_desc: "जर्मनी के लिए बहुभाषी गाइड।",
    footer_quick: "त्वरित लिंक",
    footer_popular: "लोकप्रिय गाइड",
    footer_jobs: "निवास और नौकरी",
    footer_health: "स्वास्थ्य बीमा",
    footer_home: "घर ढूँढना",
    footer_legal: "कानूनी सहायता",
    footer_language: "जर्मन भाषा",
    footer_emergency: "आपातकाल",
    footer_disclaimer_heading: "अस्वीकरण",
    hero_start: "राज्य से शुरू करें",
    hero_emergency: "आपातकालीन सहायता",
    hero_trusted: "विश्वसनीय मार्गदर्शन",
    hero_trusted_sub: "आधिकारिक जर्मन स्रोत",
    journey_kicker: "त्वरित शुरुआत",
    journey_new: "मैं जर्मनी में नया हूँ",
    journey_new_sub: "पहले सप्ताह की सूची",
    journey_visa: "वीज़ा सहायता चाहिए",
    journey_visa_sub: "परमिट और काम",
    journey_housing: "आवास सहायता चाहिए",
    journey_housing_sub: "किराया और अधिकार",
    journey_legal: "कानूनी सहायता चाहिए",
    journey_legal_sub: "अधिकार और समय-सीमा",
    journey_language: "जर्मन सीखना चाहता हूँ",
    journey_language_sub: "दैनिक वाक्यांश",
    wizard_student: "छात्र यात्रा",
    wizard_student_sub: "पढ़ाई, आवास, बीमा।",
    wizard_worker: "कुशल कार्यकर्ता",
    wizard_worker_sub: "वीज़ा, रोज़गार, ब्लू कार्ड।",
    wizard_family: "परिवार",
    wizard_family_sub: "पुनर्मिलन, बाल देखभाल।",
    wizard_researcher: "शोधकर्ता / PhD",
    wizard_researcher_sub: "विश्वविद्यालय, समझौता, निवास।",
    wizard_entrepreneur: "उद्यमी",
    wizard_entrepreneur_sub: "व्यवसाय, पंजीकरण, कर।",
    wizard_refugee: "शरणार्थी",
    wizard_refugee_sub: "सुरक्षित, आधिकारिक मार्ग।",
    translation_badge: "पूर्ण अनुवाद प्रगति में है",
    ...
    about_kicker: 'वास्तविक जीवन के लिए बनाया गया',
    about_title: 'अगला कदम खोजने का शांत तरीका',
    about_sub: 'Navigate Germany बिखरी हुई सार्वजनिक जानकारी को स्पष्ट जुड़े हुए चरणों में लाता है।',
    about_official: 'आधिकारिक-लिंक केंद्रित',
    about_official_sub: 'सरकारी प्राधिकरण और विश्वसनीय सेवाएँ',
    about_explore: 'तलाश करना आसान',
    about_explore_sub: 'स्थिति, गाइड या बुंडेसलैंड के अनुसार',
    about_mobile: 'मोबाइल फर्स्ट',
    about_mobile_sub: 'ऐप की तरह काम करने के लिए डिज़ाइन किया गया',
    about_free: 'उपयोग के लिए मुफ़्त',
    about_free_sub: 'कोई खाता या API कुंजी आवश्यक नहीं',
    disclaimer_title: 'महत्वपूर्ण:',
    disclaimer_text: 'यह प्लेटफ़ॉर्म सामान्य मार्गदर्शन और आधिकारिक जर्मन स्रोतों के लिंक प्रदान करता है।',
    footer_desc: 'जर्मनी में रहने, काम करने और बसने में मदद के लिए आधिकारिक लिंक के साथ एक बहुभाषी गाइड।',
    footer_quick: 'त्वरित लिंक',
    footer_popular: 'लोकप्रिय गाइड',
    footer_jobs: 'निवास और नौकरी',
    footer_health: 'स्वास्थ्य बीमा',
    ...
    hero_emergency: 'आपातकालीन सहायता',
    hero_trusted: 'विश्वसनीय मार्गदर्शन',
    hero_trusted_sub: 'आधिकारिक जर्मन स्रोतों के लिंक',
    journey_kicker: 'त्वरित शुरुआत',
    journey_new: 'मैं जर्मनी में नया हूँ',
    journey_new_sub: 'पहले सप्ताह की चेकलिस्ट',
    journey_visa: 'मुझे वीज़ा / निवास में मदद चाहिए',
    journey_visa_sub: 'परमिट और काम के रास्ते',
    journey_housing: 'मुझे आवास में मदद चाहिए',
    journey_housing_sub: 'किराया और किरायेदार अधिकार',
    journey_legal: 'मुझे आपातकालीन / कानूनी मदद चाहिए',
    journey_legal_sub: 'अधिकार, पत्र और समय-सीमाएँ',
    journey_language: 'मैं जर्मन सीखना चाहता हूँ',
    journey_language_sub: 'दैनिक वाक्यांश और अभ्यास',
    wizard_student: 'छात्र यात्रा',
    wizard_student_sub: 'अध्ययन, आवास, बीमा और निवास के चरण।',
    wizard_worker: 'कुशल कार्यकर्ता',
    wizard_worker_sub: 'वीज़ा, रोज़गार, ब्लू कार्ड और बसना।',
    wizard_family: 'परिवार',
    wizard_family_sub: 'पुनर्मिलन, बाल देखभाल, स्कूल और लाभ।',
    wizard_researcher: 'शोधकर्ता / PhD',
    wizard_researcher_sub: 'विश्वविद्यालय, होस्टिंग समझौता और निवास।',
    wizard_entrepreneur: 'उद्यमी',
    wizard_entrepreneur_sub: 'व्यवसाय मार्ग, पंजीकरण और कर।',
    wizard_refugee: 'शरणार्थी / शरण मांगने वाला',
    wizard_refugee_sub: 'समर्थन और सलाह के लिए सुरक्षित, आधिकारिक मार्ग।',
    translation_badge: 'पूर्ण अनुवाद प्रगति में है',
    language_guide: 'जर्मन भाषा गाइड खोलें',
    saved: 'सहेजा गया',
    more: 'अधिक',,
  fa: {
