...
const TRANSLATIONS = {
  en: {
    ...
    journey_title: "Start here — What do you need?",
    journey_sub: "Choose your situation and go directly to the most useful guide.",
    footer_built: "Built with care by Shaista Shabbir",
    footer_disclaimer: "Information is for general guidance only. Always check official sources.",
    ...
    about_sub: "Navigate Germany turns scattered public information into clear journeys while keeping official authorities one click away.",
    ...
    disclaimer_text: "This platform provides general guidance and links to official sources. Always verify information with official German authorities.",
    footer_desc: "A multilingual guide with official links to help you live, work, study, and thrive in Germany.",
    ...
    hero_eyebrow: "Official sources. Clear next steps.",
    ...
    language_title: "Guidance that feels easier to understand",
    language_sub: "Choose your preferred language for homepage guidance. Official links remain available for verification.",
    language_count: "10 supported languages",
    language_list: "English, German, Arabic, Turkish, Urdu, Russian, French, Persian, Italian, and Ukrainian.",
  },
  de: {
    dir: "ltr",
    nav_home: "Startseite",
    ...
    journey_title: "Hier starten — Was brauchen Sie?",
    journey_sub: "Wählen Sie Ihre Situation und öffnen Sie direkt den passenden Ratgeber.",
    footer_built: "Mit Sorgfalt erstellt von Shaista Shabbir",
    footer_disclaimer: "Nur allgemeine Orientierung. Bitte offizielle Quellen prüfen.",
    ...
    about_kicker: "Für den Alltag gebaut",
    about_title: "Ruhiger zum nächsten Schritt",
    about_sub: "Navigate Germany bündelt verstreute öffentliche Informationen in klaren Wegen.",
    about_official: "Offizielle Links im Fokus",
    about_official_sub: "Behörden und vertrauenswürdige Dienste",
    about_explore: "Einfach zu erkunden",
    about_explore_sub: "Nach Situation, Ratgeber oder Bundesland",
    about_mobile: "Mobil zuerst",
    about_mobile_sub: "Funktioniert wie eine App",
    about_free: "Kostenlos nutzbar",
    about_free_sub: "Kein Konto und kein API-Schlüssel nötig",
    disclaimer_title: "Wichtig:",
    disclaimer_text: "Diese Plattform bietet allgemeine Orientierung und offizielle Links. Prüfen Sie Angaben immer bei deutschen Behörden.",
    footer_desc: "Mehrsprachiger Ratgeber mit offiziellen Links für Leben, Arbeit und Studium in Deutschland.",
    footer_quick: "Schnelllinks",
    footer_popular: "Beliebte Ratgeber",
    footer_jobs: "Aufenthalt & Arbeit",
    footer_health: "Krankenversicherung",
    footer_home: "Wohnung finden",
    footer_legal: "Rechtshilfe",
    footer_language: "Deutsch lernen",
    footer_emergency: "Notfall",
    footer_disclaimer_heading: "Hinweis",
    hero_eyebrow: "Offizielle Quellen. Klare nächste Schritte.",
    ...
    journey_visa: "Ich brauche Visa- oder Aufenthaltshilfe",
    journey_visa_sub: "Erlaubnisse und Arbeitswege",
    journey_housing: "Ich brauche Hilfe beim Wohnen",
    journey_housing_sub: "Mieten und Mieterrechte",
    journey_legal: "Ich brauche Notfall- oder Rechtshilfe",
    journey_legal_sub: "Rechte, Briefe und Fristen",
    journey_language: "Ich möchte Deutsch lernen",
    journey_language_sub: "Alltagssätze und Übung",
    ...
    language_guide: "Deutschen Sprachratgeber öffnen",
    saved: "Gespeichert",
    more: "Mehr",
    language_kicker: "Mehrsprachig gedacht",
    language_title: "Orientierung, die leichter verständlich ist",
    language_sub: "Wählen Sie Ihre Sprache. Offizielle Links bleiben zur Prüfung verfügbar.",
    language_count: "10 unterstützte Sprachen",
    language_list: "Englisch, Deutsch, Arabisch, Türkisch, Urdu, Russisch, Französisch, Persisch, Italienisch und Ukrainisch.",
  },
  ur: {
    dir: "rtl",
    nav_home: "ہوم",
    ...
    journey_title: "یہاں سے شروع کریں — آپ کو کیا چاہیے؟",
    journey_sub: "اپنی صورتحال منتخب کریں اور مناسب رہنما پر جائیں۔",
    footer_built: "Shaista Shabbir نے احتیاط سے بنایا",
    footer_disclaimer: "معلومات صرف عمومی رہنمائی کے لیے ہیں۔ سرکاری ذرائع دیکھیں۔",
    ...
    about_kicker: "حقیقی زندگی کے لیے",
    about_title: "اگلا قدم تلاش کرنے کا پرسکون طریقہ",
    about_sub: "Navigate Germany بکھری ہوئی سرکاری معلومات کو واضح راستوں میں جمع کرتا ہے۔",
    about_official: "سرکاری لنکس پر توجہ",
    about_official_sub: "سرکاری ادارے اور قابل اعتماد خدمات",
    about_explore: "آسان تلاش",
    about_explore_sub: "صورتحال، رہنما یا ریاست کے لحاظ سے",
    about_mobile: "موبائل فرسٹ",
    about_mobile_sub: "ایپ جیسا تجربہ",
    about_free: "مفت استعمال",
    about_free_sub: "اکاؤنٹ یا API کلید کی ضرورت نہیں",
    disclaimer_title: "اہم:",
    disclaimer_text: "یہ پلیٹ فارم عمومی رہنمائی اور سرکاری لنکس دیتا ہے۔ معلومات کی جرمن حکام سے ہمیشہ تصدیق کریں۔",
    footer_desc: "جرمنی میں رہنے، کام اور تعلیم کے لیے سرکاری لنکس والا کثیر لسانی رہنما۔",
    footer_quick: "فوری لنکس",
    footer_popular: "مشہور رہنما",
    footer_jobs: "رہائش اور ملازمت",
    footer_health: "ہیلتھ انشورنس",
    footer_home: "گھر تلاش کریں",
    footer_legal: "قانونی مدد",
    footer_language: "جرمن زبان",
    footer_emergency: "ہنگامی",
    footer_disclaimer_heading: "اعلان",
    hero_eyebrow: "سرکاری ذرائع۔ واضح اگلے اقدامات۔",
    hero_start: "ریاست سے شروع کریں",
    hero_emergency: "ہنگامی مدد",
    hero_trusted: "قابل اعتماد رہنمائی",
    hero_trusted_sub: "جرمن سرکاری ذرائع کے لنکس",
    journey_kicker: "فوری آغاز",
    journey_new: "میں جرمنی میں نیا ہوں",
    journey_new_sub: "پہلے ہفتے کی چیک لسٹ",
    journey_visa: "مجھے ویزا یا رہائش میں مدد چاہیے",
    ...
    journey_legal: "مجھے ہنگامی یا قانونی مدد چاہیے",
    journey_legal_sub: "حقوق، خطوط اور آخری تاریخیں",
    journey_language: "میں جرمن سیکھنا چاہتا ہوں",
    journey_language_sub: "روزمرہ جملے اور مشق",
    ...
    language_guide: "جرمن زبان کا رہنما کھولیں",
    saved: "محفوظ",
    more: "مزید",
    language_kicker: "کثیر لسانی ڈیزائن",
    language_title: "آسانی سے سمجھ آنے والی رہنمائی",
    language_sub: "اپنی پسندیدہ زبان منتخب کریں اور سرکاری لنکس سے تصدیق کریں۔",
    language_count: "10 معاون زبانیں",
    language_list: "انگریزی، جرمن، عربی، ترکی، اردو، روسی، فرانسیسی، فارسی، اطالوی اور یوکرینی۔",
  },
  ar: {
    dir: "rtl",
    nav_home: "الرئيسية",
    ...
    journey_title: "ابدأ هنا — ماذا تحتاج؟",
    journey_sub: "اختر وضعك وانتقل مباشرة إلى الدليل الأنسب.",
    footer_built: "من إعداد Shaista Shabbir بعناية",
    footer_disclaimer: "المعلومات للإرشاد العام فقط. تحقق من المصادر الرسمية.",
    ...
    about_kicker: "مصمم للحياة اليومية",
    about_title: "طريقة أهدأ لمعرفة خطوتك التالية",
    about_sub: "يجمع Navigate Germany المعلومات العامة المتفرقة في مسارات واضحة.",
    about_official: "التركيز على الروابط الرسمية",
    about_official_sub: "السلطات العامة والخدمات الموثوقة",
    about_explore: "سهل الاستكشاف",
    about_explore_sub: "حسب الحالة أو الدليل أو الولاية",
    about_mobile: "مصمم للهاتف أولاً",
    about_mobile_sub: "تجربة تشبه التطبيق",
    about_free: "مجاني للاستخدام",
    about_free_sub: "لا يحتاج حساباً أو مفتاح API",
    disclaimer_title: "مهم:",
    disclaimer_text: "تقدم المنصة إرشادات عامة وروابط رسمية. تحقق دائماً من المعلومات لدى السلطات الألمانية.",
    footer_desc: "دليل متعدد اللغات بروابط رسمية للحياة والعمل والدراسة في ألمانيا.",
    footer_quick: "روابط سريعة",
    footer_popular: "أدلة شائعة",
    footer_jobs: "الإقامة والعمل",
    footer_health: "التأمين الصحي",
    footer_home: "العثور على سكن",
    footer_legal: "مساعدة قانونية",
    footer_language: "اللغة الألمانية",
    footer_emergency: "الطوارئ",
    footer_disclaimer_heading: "إخلاء مسؤولية",
    hero_eyebrow: "مصادر رسمية. خطوات واضحة.",
    hero_start: "ابدأ حسب الولاية",
    hero_emergency: "مساعدة طارئة",
    hero_trusted: "إرشادات موثوقة",
    hero_trusted_sub: "روابط إلى مصادر ألمانية رسمية",
    journey_kicker: "بداية سريعة",
    journey_new: "أنا جديد في ألمانيا",
    journey_new_sub: "قائمة الأسبوع الأول",
    journey_visa: "أحتاج مساعدة في التأشيرة أو الإقامة",
    journey_visa_sub: "التصاريح ومسارات العمل",
    journey_housing: "أحتاج مساعدة في السكن",
    journey_housing_sub: "الإيجار وحقوق المستأجر",
    journey_legal: "أحتاج مساعدة طارئة أو قانونية",
    journey_legal_sub: "الحقوق والرسائل والمواعيد",
    journey_language: "أريد تعلم الألمانية",
    journey_language_sub: "عبارات يومية وتمارين",
    ...
    saved: "محفوظ",
    more: "المزيد",
    language_kicker: "متعدد اللغات من الأساس",
    language_title: "إرشادات أسهل في الفهم",
    language_sub: "اختر لغتك المفضلة وتحقق دائماً من الروابط الرسمية.",
    language_count: "10 لغات مدعومة",
    language_list: "الإنجليزية والألمانية والعربية والتركية والأردية والروسية والفرنسية والفارسية والإيطالية والأوكرانية.",
  },
  fa: {
    dir: "rtl",
    nav_home: "خانه",
    ...
    journey_title: "از اینجا شروع کنید — چه چیزی نیاز دارید؟",
    journey_sub: "وضعیت خود را انتخاب کنید و مستقیماً به راهنمای مناسب بروید.",
    footer_built: "با دقت توسط Shaista Shabbir ساخته شده",
    footer_disclaimer: "اطلاعات فقط راهنمای عمومی است. منابع رسمی را بررسی کنید.",
    ...
    about_kicker: "برای زندگی واقعی",
    about_title: "راهی آرام‌تر برای یافتن گام بعدی",
    about_sub: "Navigate Germany اطلاعات پراکنده عمومی را به مسیرهای روشن تبدیل می‌کند.",
    about_official: "تمرکز بر پیوندهای رسمی",
    about_official_sub: "نهادهای عمومی و خدمات معتبر",
    about_explore: "جست‌وجوی آسان",
    about_explore_sub: "بر اساس وضعیت، راهنما یا ایالت",
    about_mobile: "اول موبایل",
    about_mobile_sub: "طراحی‌شده مانند اپ",
    about_free: "استفاده رایگان",
    about_free_sub: "بدون حساب یا کلید API",
    disclaimer_title: "مهم:",
    disclaimer_text: "این پلتفرم راهنمای عمومی و پیوندهای رسمی ارائه می‌کند. اطلاعات را همیشه با مقامات آلمان بررسی کنید.",
    footer_desc: "راهنمای چندزبانه با پیوندهای رسمی برای زندگی، کار و تحصیل در آلمان.",
    footer_quick: "پیوندهای سریع",
    footer_popular: "راهنماهای محبوب",
    footer_jobs: "اقامت و کار",
    footer_health: "بیمه درمانی",
    footer_home: "یافتن خانه",
    footer_legal: "کمک حقوقی",
    footer_language: "زبان آلمانی",
    footer_emergency: "اضطراری",
    footer_disclaimer_heading: "سلب مسئولیت",
    hero_eyebrow: "منابع رسمی. گام‌های روشن.",
    hero_start: "شروع بر اساس ایالت",
    hero_emergency: "کمک اضطراری",
    hero_trusted: "راهنمای قابل اعتماد",
    hero_trusted_sub: "پیوند به منابع رسمی آلمان",
    journey_kicker: "شروع سریع",
    journey_new: "تازه به آلمان آمده‌ام",
    journey_new_sub: "فهرست هفته اول",
    journey_visa: "برای ویزا یا اقامت کمک می‌خواهم",
    journey_visa_sub: "مجوزها و مسیرهای کاری",
    journey_housing: "برای مسکن کمک می‌خواهم",
    journey_housing_sub: "اجاره و حقوق مستأجر",
    journey_legal: "کمک اضطراری یا حقوقی می‌خواهم",
    journey_legal_sub: "حقوق، نامه‌ها و مهلت‌ها",
    journey_language: "می‌خواهم آلمانی یاد بگیرم",
    journey_language_sub: "عبارت‌های روزانه و تمرین",
    ...
    saved: "ذخیره شد",
    more: "بیشتر",
    language_kicker: "طراحی چندزبانه",
    language_title: "راهنمایی که فهم آن آسان‌تر است",
    language_sub: "زبان دلخواه را انتخاب کنید و اطلاعات را از پیوندهای رسمی بررسی کنید.",
    language_count: "۱۰ زبان پشتیبانی‌شده",
    language_list: "انگلیسی، آلمانی، عربی، ترکی، اردو، روسی، فرانسوی، فارسی، ایتالیایی و اوکراینی.",
  },
  tr: {
    dir: "ltr",
    nav_home: "Ana Sayfa",
    ...
    journey_title: "Buradan başlayın — Neye ihtiyacınız var?",
    journey_sub: "Durumunuzu seçin ve en yararlı rehbere gidin.",
    footer_built: "Shaista Shabbir tarafından özenle hazırlandı",
    footer_disclaimer: "Bilgiler yalnızca genel rehberlik içindir. Resmi kaynakları kontrol edin.",
    ...
    about_kicker: "Gerçek yaşam için",
    about_title: "Sonraki adımı bulmanın daha sakin yolu",
    about_sub: "Navigate Germany dağınık kamu bilgilerini net yolculuklarda birleştirir.",
    about_official: "Resmi bağlantı odaklı",
    about_official_sub: "Kamu kurumları ve güvenilir hizmetler",
    about_explore: "Kolay keşif",
    about_explore_sub: "Duruma, rehbere veya eyalete göre",
    about_mobile: "Önce mobil",
    about_mobile_sub: "Uygulama gibi çalışır",
    about_free: "Ücretsiz kullanım",
    about_free_sub: "Hesap veya API anahtarı gerekmez",
    disclaimer_title: "Önemli:",
    disclaimer_text: "Bu platform genel rehberlik ve resmi bağlantılar sunar. Bilgileri Alman makamlarından doğrulayın.",
    footer_desc: "Almanya'da yaşam, çalışma ve eğitim için resmi bağlantılı çok dilli rehber.",
    footer_quick: "Hızlı Bağlantılar",
    footer_popular: "Popüler Rehberler",
    footer_jobs: "Oturum ve İş",
    footer_health: "Sağlık Sigortası",
    footer_home: "Ev Bulma",
    footer_legal: "Hukuki Yardım",
    footer_language: "Almanca",
    footer_emergency: "Acil Durum",
    footer_disclaimer_heading: "Sorumluluk Reddi",
    hero_eyebrow: "Resmi kaynaklar. Net sonraki adımlar.",
    ...
    journey_visa: "Vize veya oturum yardımı gerekiyor",
    ...
    journey_legal: "Acil veya hukuki yardım gerekiyor",
    journey_legal_sub: "Haklar, mektuplar ve süreler",
    ...
    saved: "Kaydedildi",
    more: "Daha fazla",
    language_kicker: "Çok dilli tasarım",
    language_title: "Anlaması daha kolay rehberlik",
    language_sub: "Tercih ettiğiniz dili seçin; resmi bağlantılar doğrulama için kalır.",
    language_count: "10 desteklenen dil",
    language_list: "İngilizce, Almanca, Arapça, Türkçe, Urduca, Rusça, Fransızca, Farsça, İtalyanca ve Ukraynaca.",
  },
  uk: {
    dir: "ltr",
    nav_home: "Головна",
    ...
    journey_title: "Почніть тут — Що вам потрібно?",
    journey_sub: "Оберіть ситуацію та одразу відкрийте потрібний путівник.",
    footer_built: "Створено з турботою Shaista Shabbir",
    footer_disclaimer: "Інформація має загальний характер. Перевіряйте офіційні джерела.",
    ...
    about_kicker: "Для реального життя",
    about_title: "Спокійніший спосіб знайти наступний крок",
    about_sub: "Navigate Germany об'єднує розрізнену державну інформацію у зрозумілі маршрути.",
    about_official: "Офіційні посилання",
    about_official_sub: "Державні органи та надійні служби",
    about_explore: "Легко шукати",
    about_explore_sub: "За ситуацією, темою або землею",
    about_mobile: "Спочатку мобільний",
    about_mobile_sub: "Працює як застосунок",
    about_free: "Безкоштовно",
    about_free_sub: "Без облікового запису та API-ключа",
    disclaimer_title: "Важливо:",
    disclaimer_text: "Платформа надає загальні поради й офіційні посилання. Завжди перевіряйте дані в органах влади Німеччини.",
    footer_desc: "Багатомовний путівник з офіційними посиланнями для життя, роботи та навчання в Німеччині.",
    ...
    footer_legal: "Правова допомога",
    footer_language: "Німецька мова",
    footer_emergency: "Екстрена допомога",
    footer_disclaimer_heading: "Застереження",
    hero_eyebrow: "Офіційні джерела. Чіткі наступні кроки.",
    hero_start: "Почати із землі",
    hero_emergency: "Екстрена допомога",
    hero_trusted: "Надійні поради",
    hero_trusted_sub: "Посилання на офіційні джерела Німеччини",
    journey_kicker: "Швидкий старт",
    journey_new: "Я щойно прибув до Німеччини",
    journey_new_sub: "Список на перший тиждень",
    journey_visa: "Потрібна допомога з візою або проживанням",
    ...
    journey_legal: "Потрібна екстрена або правова допомога",
    journey_legal_sub: "Права, листи та строки",
    journey_language: "Хочу вивчати німецьку",
    ...
    language_guide: "Відкрити путівник з німецької",
    saved: "Збережено",
    more: "Більше",
    language_kicker: "Багатомовний дизайн",
    language_title: "Поради, які легше зрозуміти",
    language_sub: "Оберіть мову та перевіряйте дані за офіційними посиланнями.",
    language_count: "10 підтримуваних мов",
    language_list: "Англійська, німецька, арабська, турецька, урду, російська, французька, перська, італійська та українська.",
  },
  ru: {
    dir: "ltr",
    nav_home: "Главная",
    ...
    journey_title: "Начните здесь — Что вам нужно?",
    journey_sub: "Выберите ситуацию и сразу откройте нужное руководство.",
    footer_built: "Создано с заботой: Shaista Shabbir",
    footer_disclaimer: "Информация носит общий характер. Проверяйте официальные источники.",
    ...
    about_kicker: "Для реальной жизни",
    about_title: "Спокойный путь к следующему шагу",
    about_sub: "Navigate Germany собирает разрозненную государственную информацию в понятные маршруты.",
    about_official: "Официальные ссылки",
    about_official_sub: "Государственные органы и надёжные службы",
    about_explore: "Легко найти",
    about_explore_sub: "По ситуации, теме или земле",
    about_mobile: "Сначала мобильный",
    about_mobile_sub: "Работает как приложение",
    about_free: "Бесплатно",
    about_free_sub: "Без аккаунта и ключа API",
    disclaimer_title: "Важно:",
    disclaimer_text: "Платформа даёт общую информацию и официальные ссылки. Всегда проверяйте данные у немецких властей.",
    footer_desc: "Многоязычный путеводитель с официальными ссылками для жизни, работы и учёбы в Германии.",
    footer_quick: "Быстрые ссылки",
    footer_popular: "Популярные руководства",
    footer_jobs: "ВНЖ и работа",
    footer_health: "Медстрахование",
    footer_home: "Поиск жилья",
    footer_legal: "Правовая помощь",
    footer_language: "Немецкий язык",
    footer_emergency: "Экстренная помощь",
    footer_disclaimer_heading: "Отказ от ответственности",
    hero_eyebrow: "Официальные источники. Понятные шаги.",
    hero_start: "Начать с земли",
    hero_emergency: "Экстренная помощь",
    hero_trusted: "Надёжная информация",
    hero_trusted_sub: "Ссылки на официальные источники Германии",
    journey_kicker: "Быстрый старт",
    journey_new: "Я недавно в Германии",
    journey_new_sub: "План на первую неделю",
    journey_visa: "Нужна помощь с визой или ВНЖ",
    journey_visa_sub: "Разрешения и пути к работе",
    journey_housing: "Нужна помощь с жильём",
    journey_housing_sub: "Аренда и права жильцов",
    journey_legal: "Нужна экстренная или правовая помощь",
    journey_legal_sub: "Права, письма и сроки",
    journey_language: "Я хочу учить немецкий",
    journey_language_sub: "Повседневные фразы и практика",
    ...
    language_guide: "Открыть руководство по немецкому",
    saved: "Сохранено",
    more: "Ещё",
    language_kicker: "Многоязычный подход",
    language_title: "Информация, которую легче понять",
    language_sub: "Выберите язык и проверяйте данные по официальным ссылкам.",
    language_count: "10 поддерживаемых языков",
    language_list: "Английский, немецкий, арабский, турецкий, урду, русский, французский, персидский, итальянский и украинский.",
  },
  hi: {
    dir: "ltr",
    ...
    nav_home: "होम",
    nav_states: "राज्य",
    nav_guides: "मार्गदर्शिकाएं",
    nav_languages: "भाषाएं",
    nav_about: "हमारे बारे में",
    nav_resources: "संसाधन",
    emg_help: "आपातकालीन सहायता",
    emg_112: "एम्बुलेंस और अग्निशमन",
    emg_110: "पुलिस",
    emg_116: "ड्यूटी डॉक्टर",
    emg_crisis: "संकट लाइन",
    stat_states: "राज्य",
    stat_langs: "भाषाएं",
    stat_modules: "मार्गदर्शिकाएं",
    stat_links: "आधिकारिक लिंक",
    stat_emg: "आपातकालीन तैयारी",
    guides_kicker: "जर्मनी में जीवन",
    guides_title: "जीवन मार्गदर्शिकाएं खोजें",
    guides_sub: "जर्मनी में रहने, काम करने, पढ़ने और बसने के लिए व्यावहारिक मार्गदर्शिकाएं।",
    states_kicker: "स्थानीय जानकारी",
    states_title: "राज्य के अनुसार खोजें",
    states_sub: "स्थानीय अधिकारियों और आधिकारिक संसाधनों के लिए अपना राज्य चुनें।",
    hero_eyebrow: "आधिकारिक स्रोत। स्पष्ट कदम।",
    open_guide: "मार्गदर्शिका खोलें →",
    start_by_state: "राज्य से शुरू करें →",
    emergency_help: "आपातकालीन सहायता",
    search: "खोजें",
    learn_more: "और जानें",
    coming_soon: "जल्द आ रहा है",
    official_source: "आधिकारिक स्रोत",
    last_checked: "अंतिम जांच",
    back_modules: "सभी मार्गदर्शिकाएं",
    quick_checklist: "त्वरित चेकलिस्ट",
    related_guides: "संबंधित मार्गदर्शिकाएं",
    browse_guides: "सभी मार्गदर्शिकाएं",
    resources: "संसाधन",
    save: "सहेजें",
    remove: "हटाएं",
    ask_ai: "जर्मनी AI से पूछें",
    ai_preview: "AI सहायक पूर्वावलोकन",
    ai_coming: "पूर्ण AI जल्द आएगा",
    journey_title: "जर्मनी की आपकी यात्रा",
    journey_sub: "वीजा से बसने तक कदम दर कदम।",
    footer_built: "प्रवासियों के लिए बनाया गया।",
    footer_disclaimer: "केवल सामान्य जानकारी — आधिकारिक अधिकारियों से सत्यापित करें।",
    lang_status_title: "अनुवाद स्थिति",
    lang_status_core: "मुख्य इंटरफेस: उपलब्ध",
    lang_status_guides: "पूर्ण मार्गदर्शिकाएं: प्रगति में",
    lang_status_official: "आधिकारिक लिंक: अपरिवर्तित",
    guide_notice: "पूर्ण अनुवाद प्रगति में है। आधिकारिक स्रोत जर्मन या अंग्रेजी में हो सकते हैं।",
    module_housing: "आवास",
    module_healthcare: "स्वास्थ्य सेवा",
    module_jobs: "नौकरी और वीजा",
    module_legal: "कानूनी सहायता",
    module_language: "भाषा",
    module_costs: "जीवन यापन लागत",
    module_education: "शिक्षा",
    module_integration: "एकीकरण",
    module_bureaucracy: "नौकरशाही",
    module_family: "परिवार और बच्चे",
    module_emergency: "आपातकाल",
    module_banking: "बैंकिंग और कर",
  ...
  fr: {
    ...
    journey_title: "Commencez ici — De quoi avez-vous besoin ?",
    journey_sub: "Choisissez votre situation et ouvrez directement le guide utile.",
    footer_built: "Créé avec soin par Shaista Shabbir",
    footer_disclaimer: "Informations générales uniquement. Vérifiez les sources officielles.",
    ...
    about_title: "Une façon plus sereine de trouver la prochaine étape",
    about_sub: "Navigate Germany rassemble les informations publiques dans des parcours clairs.",
    about_official: "Liens officiels",
    about_official_sub: "Autorités publiques et services fiables",
    about_explore: "Facile à explorer",
    about_explore_sub: "Par situation, guide ou Land",
    about_mobile: "Mobile d'abord",
    about_mobile_sub: "Pensé comme une application",
    about_free: "Utilisation gratuite",
    about_free_sub: "Sans compte ni clé API",
    disclaimer_title: "Important :",
    disclaimer_text: "Cette plateforme fournit des conseils généraux et des liens officiels. Vérifiez toujours auprès des autorités allemandes.",
    footer_desc: "Guide multilingue avec liens officiels pour vivre, travailler et étudier en Allemagne.",
    footer_quick: "Liens rapides",
    footer_popular: "Guides populaires",
    footer_jobs: "Séjour et emploi",
    ...
    hero_eyebrow: "Sources officielles. Étapes claires.",
    hero_start: "Commencer par Land",
    hero_emergency: "Aide d'urgence",
    hero_trusted: "Conseils fiables",
    hero_trusted_sub: "Liens vers les sources officielles allemandes",
    journey_kicker: "Démarrage rapide",
    journey_new: "Je viens d'arriver en Allemagne",
    journey_new_sub: "Liste de la première semaine",
    journey_visa: "J'ai besoin d'aide pour le visa ou le séjour",
    journey_visa_sub: "Permis et voies d'emploi",
    journey_housing: "J'ai besoin d'aide au logement",
    journey_housing_sub: "Location et droits des locataires",
    journey_legal: "J'ai besoin d'aide urgente ou juridique",
    ...
    language_title: "Des conseils plus faciles à comprendre",
    language_sub: "Choisissez votre langue et vérifiez les informations via les liens officiels.",
    language_count: "10 langues disponibles",
    language_list: "Anglais, allemand, arabe, turc, ourdou, russe, français, persan, italien et ukrainien.",
  },
};
